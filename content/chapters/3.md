...
If you're a tester (or a team of testers) and you will be building and maintaining the test automation, then it's best to consider what languages you (and your team) already have experience with, or are interested in gaining experience with, rather than what the application is built in. __Your Selenium tests DO NOT have to be written in the same language as the application you are testing__. Have a discussion with your team to see what interests them and go from there.
...
Choosing a programming language for automated testing is not a decision that should be taken lightly. If you're just starting out (or looking to port your tests) then considering and discussing these things will help position you for greater long term success.
