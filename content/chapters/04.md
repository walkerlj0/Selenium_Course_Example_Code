...
[Microsoft Visual Studio](https://www.visualstudio.com/) is _the_ IDE for the Microsoft Development Ecosystem. As of right now the best way to use it is on a Windows machine. Thankfully, it's free. You can download it from [here](https://www.visualstudio.com/).

If you're not running Windows then you'll want to set up a virtual machine through the use of something like [VirtualBox](https://www.virtualbox.org/wiki/Downloads). Thankfully Microsoft has made virtual images of Windows available for browser testing purposes. You can find them all [here](http://dev.modern.ie/tools/vms).

After installing VirtualBox import the Windows image and start it. Then download and install Visual Studio. Now you're ready to install the necessary packages.
...
+ [`NUnit.Runners`](https://www.nuget.org/packages/NUnit.Runners/)
...
+ [C# 5.0 in a Nutshell: The Definitive Reference](https://www.amazon.com/C-5-0-Nutshell-Definitive-Reference/dp/1449320104/)
