...
For doing proper software development in Python you'd want to consider something like [Virtual Environments](http://docs.python-guide.org/en/latest/dev/virtualenvs/#virtualenvironments-ref) to effectively manage third-party dependencies. But for the needs of the examples in this book, it's not necessary.
