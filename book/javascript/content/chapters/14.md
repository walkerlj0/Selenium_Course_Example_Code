...
The test name (e.g., `testName`) gets passed in as an argument to `build` (e.g., in the `beforeEach`). To use it in `quit` we stored it in a class variable.
