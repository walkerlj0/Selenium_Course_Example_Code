...
There are roughly 1 million third-party libraries (a.k.a. "packages") available for Node.js through [`npm`](https://docs.npmjs.com/getting-started/what-is-npm). `npm` is the Node Package Manager program that comes bundled with Node.
