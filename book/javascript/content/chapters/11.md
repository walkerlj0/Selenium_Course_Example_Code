...
In this file the Selenium util DSL that we created in the last chapter and specify the locators and behavior we'll want to use on this page.
...
Let's update our Selenium util to offer this alternative `isDisplayed` method which will enable explicit waits.
