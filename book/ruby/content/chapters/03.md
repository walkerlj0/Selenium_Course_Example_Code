...
With all that being said, the rest of this book will show you how to build your own test harness (in addition to writing well factored tests) in [Ruby](https://www.ruby-lang.org/en/) with [RSpec](http://rspec.info).
