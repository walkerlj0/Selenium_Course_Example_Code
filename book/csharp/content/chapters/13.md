...
Selenium Grid lets you distribute test execution across several machines and you connect to it with Selenium `RemoteWebDriver`. You tell the Grid which browser and OS you want your test to run on through the use of Selenium's class object [`DesiredCapabilities`](https://www.selenium.dev/selenium/docs/api/dotnet/html/T_OpenQA_Selenium_Remote_DesiredCapabilities.htm), and its various subclasses for specific browser options (`ChromeOptions()`, `FirefoxOptions()`, etc.)
...
// ...
    class BaseTest
    {
        ...
        protected void SetUp()
        {
            ...
            var url = new Uri($"https://{sauceUsername}:{sauceAccessKey}@ondemand.saucelabs.com/wd/hub");
// ...
```
