...
For this example, we'll be using [the Ruby programming language](https://www.ruby-lang.org/en/), [RSpec version 2.14](http://rspec.info/) (an open-source Ruby testing framework), and [the-internet](https://github.com/tourdedave/the-internet) (an open-source web application).
