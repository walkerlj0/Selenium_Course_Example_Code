...
__NOTE: You'll need an account to use Sauce Labs. Their [free trial](https://saucelabs.com/signup/trial) offers more than enough to get you started (no credit-card required).__
...
There's a whole lot more to think about when it comes to using Selenium successfully. And it's all covered in my book -- [The Selenium Guidebook](https://seleniumguidebook.com/). It covers everything you need to know in a concise way with code examples, cheat sheets, and video walkthroughs. You can learn more about it [here](https://seleniumguidebook.com/).
