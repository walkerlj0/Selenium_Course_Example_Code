...
Let's take [our previous login example](http://sauceio.com/index.php/2014/02/getting-started-with-selenium-chapter-3-writing-your-first-selenium-test/), pull it out into a page object, and update our test accordingly.
...
For comprehensive examples like this (and a whole lot more), grab your copy of [The Selenium Guidebook](http://davehaeffner.com/selenium-guidebook/).
