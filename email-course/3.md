...
We start by creating a file called `login.rb` in the same directory as your test. In it we declare our class by naming it accordingly (`class Login`), and storing our locators in hashes within constants along the top.
